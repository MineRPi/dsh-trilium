/**
 * tsdown build for dsh-trilium: the single browser client bundle
 * (lib/client.js, CJS closure factory) registered under the package-name id
 * 'dsh-trilium'. The host half is built by tsc (lib/index.js keeps its
